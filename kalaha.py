...
class ArtificialPlayer:
    ...
    def choose_hole_tree(player, oponent):
        ...
        for i in range(1, 7):
            worst_move = -100
            for j in range(1, 7):
                artificial_game = Server.copyGame(new_player, new_oponent)
...
class Server:
    ...
    # this is a copy constructor for AI to play a new exact game
    @classmethod
    def copyGame(cls, player1, player2):
        cls.p1 = player1
        cls.p2 = player2
        # I will use boolean as a turn meaning that true is player's 1 turn
        # false player's 2 turn
    ...
    def break_iteration_if_over(self):
        ...
        if a:
            if a == 1:
                ...
                player_win = "Player2"
            print("Zwycięzcą jest: " + player_win)
        return a
